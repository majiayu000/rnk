...
pub struct FilePickerState {
    ...
    history: Vec<PathBuf>,
    /// Last submitted selection.
    submitted: Option<Vec<PathBuf>>,
    /// Whether the picker was cancelled.
    cancelled: bool,
}
...
impl FilePickerState {
    ...
    /// Get the last submitted paths.
    pub fn submitted(&self) -> Option<&[PathBuf]> {
        self.submitted.as_deref()
    }

    /// Return true when input cancelled this picker.
...
/// Handle FilePicker navigation, search, selection, submit, and cancel.
