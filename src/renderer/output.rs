...
impl Output {
            ...
            match sanitize_source_scalar(ch) {
                ...
                SourceScalar::Tab => {
                    ...
                    for _ in 0..spaces {
                        ...
                        self.write_visible_char(col, row, ' ', 1, style, clip_region.as_ref());
                        col += 1;
                    }
                }
                SourceScalar::Visible(ch) => {
                    ...
                    self.write_visible_char(col, row, ch, char_width, style, clip_region.as_ref());
                    col += char_width;
                }
            }
        }
    ...
    pub fn write_char(&mut self, x: u16, y: u16, ch: char, style: &Style) {
        ...
        // Preserve the existing dirty contract even when a structured break writes no cell.
        self.mark_dirty(row);
            ...
            SourceScalar::Tab => {
                ...
                for offset in 0..spaces {
                    ...
                    self.write_visible_char(
                        ...
                        1,
                        style,
                        self.clip_stack.last().cloned().as_ref(),
                    );
                }
            }
            SourceScalar::Visible(ch) => {
