...
| B-010 | common replay/proof entry | `cargo test --test chat_conversation_contracts exact_replay_returns_original_outcome_without_mutation -- --exact`; `cargo test --test chat_conversation_contracts reused_event_id_with_different_content_conflicts -- --exact` |
